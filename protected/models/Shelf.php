...
class Shelf extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('customers_id, items_id, eff_date, created', 'required'),
			array('customers_id, items_id, qty', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customers_id, items_id, qty, eff_date, created', 'safe', 'on'=>'search'),
		);
	}
