...
<div id="form_body">
    <div class="container-fluid">
        ...
        <h2>Stock Adjustment - <?php echo $model->code; ?></h2>
                ...
                <div class="col-sm-10">
                    <form action="<?php echo Yii::app()->createUrl('AdjItems/create') ?>" method="post" id="AdjItems-form" >
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-1">
                                <label>COST</label>
                                <input <?php echo $cost_v; ?> type="text" required="" min="0" id="cost" name="cost" class="form-control form-control-sm" placeholder="COST Rs.">
                            </div>

                            <div class="col-1">
                                <label>SELLING</label>
                                <input <?php echo $sell_v; ?> type="text" required="" min="0" id="selling" name="selling" class="form-control form-control-sm" placeholder="SELLING Rs.">
                            </div>
