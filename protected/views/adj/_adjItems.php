        ...
        <tbody class="lineitems" >
            ...
            foreach ($list as $itemArray) {
                ...
                <tr data-id="<?php echo $item->id; ?>" >
                    ...
                    <td class="text-right selitem"><?php echo sprintf('%0.2f', $item->cost); ?></td>                    
                    ...
                    <td class="selitem text-right"><?php echo number_format($item->cost * $item->{$key_var}, 2); ?></td>

                </tr>
                <?php
                $num += 1;
                $total += $item->cost * $item->{$key_var};
            }
            ?>
        </tbody>
