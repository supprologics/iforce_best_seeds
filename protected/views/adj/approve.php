<script>
    ...
    $(function () {
        ...
        var autocomplete = $("#items").tablecomplete({
            minLength: 2,
            source: "<?php echo Yii::app()->createUrl('items/loadlist/'); ?>",
    ...
    $(document).on("click", "#Adj-delete", function (e) {
        ...
        if (confirmdata == true) {
            $.ajax({
                ...
                window.location.href = "<?php echo Yii::app()->createUrl('Adj') ?>";
            });
        }
    });
    ...
    $(document).on("click", "#Adj-reedit", function (e) {
        e.preventDefault();
...
<div id="form_body">
    <div class="container-fluid">
        ...
        <h2> Stock Adjustment Approval Window - <?php echo $model->code; ?></h2>
        ...
        <div id="sdsdsd" style="overflow: auto;" >
            ...
            $this->widget('zii.widgets.CListView', array(
                ...
                'itemView' => '_adjItems_forapprovals',
        ...
        <div id="btn_bar" class="mt-2 text-right">
            <div class="row">
                <div class="col">
                    <button id="Adj-reedit" data-id="<?php echo $model->id; ?>" class="btn btn-sm btn-danger"> Revoke This & EDIT <span class="fas fa-times-circle text-danger"></span></button>
                    <button id="Adj-complete" data-id="<?php echo $model->id; ?>" class="btn  btn-sm btn-success">Approve & Print</button>
                </div>
            </div>
        </div>
