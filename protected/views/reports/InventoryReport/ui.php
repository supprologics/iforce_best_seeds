...
<div  class="row">
    <div id="datec" class="col">
        ...
        <form target="_blank" class="form-horizontal" action="<?php echo Yii::app()->createUrl('reports/loadreport/') ?>" method="post" >
            ...
            <div class="form-group row">
                <label for="name" class="col-sm-2 control-label">Stock-Lot</label>
                <div class="col-sm-4">
                    <select name="stocklot" required="true" class="custom-select custom-select-sm required" id="stocklot">
            ...
            <div  class="form-row form-group">
                <label for="name" class="col-sm-2 control-label">Effected Date</label>
                <div class="col-sm-2">
