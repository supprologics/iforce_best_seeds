...
<script>
    ...
    $(document).on("click", "#BuferStock-searchbtn", function () {
        search();
    });

    $(document).on("keyup", "#BuferStock-search", function () {
        search();
    });
...
<div class="modal fade" id="BuferStock-addmodel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="cus-form">
                    <form class="form-horizontal" action="<?php echo Yii::app()->createUrl('BuferStock/create') ?>" method="post" id="BuferStock-form">
        ...
        <div class="col-4">
            <div class="input-group">
                <div class="input-group-append">
                    <button id="BuferStock-add" data-toggle="modal" data-target="#BuferStock-addmodel" class="btn btn-secondary btn-block btn-sm" >
                        Add <span class="oi oi-plus"></span>
                    </button>
                </div>
                <input type="text" id="BuferStock-search" class="form-control form-control-sm" placeholder="Search by Name/Code etc.">
                <div class="input-group-append">
                    <button id="BuferStock-searchbtn" class="btn btn-secondary btn-sm" >Search <span class="oi oi-magnifying-glass"></span> <span class="glyphicon glyphicon-search"></span></button>
                </div>
            </div>
        </div> 
        <div class="col-auto">
            <div class="input-group">
                <select id="BuferStock-pages" name="pages" class="custom-select custom-select-sm">
