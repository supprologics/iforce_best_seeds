...
<script>
    ...
    $ (function () {
       ...
       $.widget ("custom.tablecomplete", $.ui.autocomplete, {
          ...
          _renderItem: function (table, item) {
             ...
             $ ("<td class='text-right'>").html (item.cost).appendTo ($row);
       ...
       var autocomplete = $ ("#items").tablecomplete ({
          minLength: 1,
          source: "<?php echo Yii::app()->createUrl('items/loadlistForSr/' . $model->id); ?>",
    ...
    function save () {
       ...
       $.ajax ({
          url: "<?php echo Yii::app()->createUrl("SrItems/updateAll/" . $model->id) ?>",
          data: inner_data,
          type: "POST",
    ...
    $ (document).on ("click", "#SrItems-remove", function (e) {
       e.preventDefault ();
       ...
       do {
          ...
          $.ajax ({
             url: "<?php echo Yii::app()->createUrl('SrItems/delete') ?>/" + val[i],
             success: showResponse,
             type: "POST",
             async: false,
             error: showResponse,
    ...
    $ (document).on ("click", "#Sr-complete", function (e) {
       ...
       if (confirmdata == true) {
          ...
          if (sts > 0) {
            ...
            reactive($(this),"Complete Return Note");
       }
    });
...
<div id="form_body">
    <div class="container-fluid">
        ...
        <h2>Supplier Return Note - <?php echo $model->code; ?></h2>
        ...
        <div id="inline_manu">
            <div class="row">
                <div class="col-sm-10">
                    <form action="<?php echo Yii::app()->createUrl('SrItems/create') ?>" method="post" id="SrItems-form" >
                        <input type="hidden" name="sr_id" id="sr_id" value="<?php echo $model->id; ?>" />
                        <div class="form-row">
                            <div class="col-3">
                            ...
                            <div class="col-1">
                                <label>COST</label>
                                <input type="text" readonly="" min="0" id="cost" name="cost" class="form-control form-control-sm" placeholder="COST">
                            </div>
                            <div class="col-1">
                                <label>Qty</label>
        ...
        <div id="quick_nav">
            ...
            <button id="SrItems-remove" class="btn btn-block btn-sm btn-danger"><span class="fas fa-times-circle text-danger"></span></button>
        ...
        <div id="btn_bar" class="mt-2 text-right">
            <div class="row">
                <div class="col">
                    ...
                    <button id="Sr-complete" data-id="<?php echo $model->id; ?>" class="btn  btn-sm btn-success">Complete Return Note</button>
                </div>
            </div>
        </div>
