...
<script>
    ...
    $ (document).on ("click", "#Ltn-delete", function (e) {
       ...
       var id = $ (this).attr ("data-id");
       var sts = 0;
       var confirmdata = confirm ("Are you sure, you want to Reject This ?");
       if (confirmdata == true) {
          $.ajax ({
...
<div id="form_body">
    <div class="container-fluid">
        ...
        <h2>Approvals for Internal Location Transfer Note - <?php echo $model->code; ?></h2>
        ...
        <div id="btn_bar" class="mt-2 text-right">
            <div class="row">
                <div class="col">
                    <button id="Ltn-delete" data-id="<?php echo $model->id; ?>" class="btn btn-sm btn-danger"> Reject <span class="fas fa-times-circle text-danger"></span></button>
                    <button id="Ltn-complete" data-id="<?php echo $model->id; ?>" class="btn  btn-sm btn-success">Accept</button>
                </div>
            </div>
        </div>
