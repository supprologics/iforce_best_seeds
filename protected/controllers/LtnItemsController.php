...
class LtnItemsController extends Controller {
    ...
    public function actionjsondata($id) {
        $data = LtnItems::model()->findByPk($id);
    ...
    public function actionupdateAll($id) {
        try {
            ...
            foreach ($_POST['qty'] as $key => $value) {
                ...
                $poitems = LtnItems::model()->findByAttributes(array("id" => $key));
    ...
    public function actionIndex() {
        ...
        $sql = "SELECT * FROM ltn_items WHERE online = 1 $searchtxt ORDER BY id DESC ";
    ...
    public function loadModel($id) {
        $model = LtnItems::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'ltn-items-form') {
