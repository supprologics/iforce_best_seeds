...
class CostingController extends Controller
{
	...
	public function accessRules()
	{
        ...
        public function actionjsondata($id) {
                $data = Costing::model()->findByPk($id);
	...
	public function actionIndex()
	{
                ...
                $sql = "SELECT * FROM costing WHERE online = 1 $searchtxt ORDER BY id DESC ";                
	...
	{
		$model=Costing::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='costing-form')
		{
