...
class PaymentItemsController extends Controller {
    ...
    public function actionjsondata($id) {
        $data = PaymentItems::model()->findByPk($id);
    ...
    public function actionupdateAll($id) {
        try {
            ...
            foreach ($_POST['amount'] as $key => $value) {
                ...
                $items = PaymentItems::model()->findByAttributes(array("payment_id" => $id, "invoice_id" => $key));
                if ($items == null) {
                    ...
                    $items = New PaymentItems();
                    $items->payment_id = $id;
                    $items->invoice_id = $key;
                    $items->amount = $value;
    ...
    public function actionIndex() {
        ...
        $sql = "SELECT * FROM payment_items WHERE online = 1 $searchtxt ORDER BY id DESC ";
    ...
    public function loadModel($id) {
        $model = PaymentItems::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'payment-items-form') {
